...
{
	LPCSTR					szVersion;//+00
	DWORD					dwLibVersion; //+04
	BOOL					bStop; //+08
	BOOL					bIsNT; //+0C
	BOOL					bEnablePatch; //+10
	HANDLE					hEventInited;
	EventLogFunc			fpEventLog; //+18
	FARPROC					fpErrorHandle;
	LPEVENTCALLBACKTABLE	fpCallback; //+20
	BOOL					bPreCache;
	DWORD					dwIdleSleep;
	DWORD					dwBusySleep;
	DWORD					dwMaxGame; //+30
	...
	DWORD					dwGSId;
	DWORD					dwACVersion;
	DWORD					dwCheckSum0; //+40
	DWORD					dwRealCheckSumCount;
	DWORD					dwCheckSumArray[16]; //+48
	DWORD					dwGameDifficultyCount[3][2]; //+88
