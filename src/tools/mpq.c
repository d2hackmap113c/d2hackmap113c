...
void uncompress() {
	...
	char *name="patch_d2";
	sprintf(path,"D:/game/diablo2025/%s.mpq",name);
	sprintf(listprefix,"D:/game/diablo2025/t/%s",name);
	sprintf(outpath,"D:/game/diablo2025/t/s.mpq",name);
